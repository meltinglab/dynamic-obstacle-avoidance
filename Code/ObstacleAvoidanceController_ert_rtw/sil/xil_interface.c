 ...
 *
 * SIL generated interface for code: "ObstacleAvoidanceController"
 *
 */
...
static XILIOData xil_fcnid0_task1_output_u[15];
      ...
      if (!initComplete) {
...

        {
          void * dataAddress = (void *)
            &(ObstacleAvoidanceController_U.Ref_pSteps[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 60 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }

        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.SafeX);
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.SafeY);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.EndX);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.EndY);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *)
            &(ObstacleAvoidanceController_U.detection);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.Zone);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.Lw);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.State[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.u[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 2 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }

        {
          void * dataAddress = (void *) &(ObstacleAvoidanceController_U.param[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 2 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
